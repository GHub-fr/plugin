...
public class textTranslation {
    ...
    public static String banned(lang.languages languages) {
        switch (languages) {
            case fr:
                return "§4Vous êtes §lbanni §r§4!\n§6Discord §rpour toutes demandes ghub.fr/discord";
            case en:
                return "§4You are §lbanned §r§4!\n§6Discord §rfor all requests ghub.fr/discord";
            default:
                return "";
        }
    }
    ...
    public static String WelcomeBack(lang.languages languages, String playerName) {
        switch (languages) {
            case fr:
                return "§6§lBon retour §r" + playerName + " §2sur §lghub.fr";
            case en:
                return "§6§lWelcome back §r" + playerName + " §2on §lghub.fr";
            default:
                return "";
        }
    }
